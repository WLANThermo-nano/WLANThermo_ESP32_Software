...
#define TRANSITION_TIME 0 /*((theme.flags & LVTHEME_FLAG_NO_TRANSITION) ? 0 : 150)*/
#define BORDER_WIDTH LV_DPX(2)
#define OUTLINE_WIDTH ((theme.flags & LVTHEME_FLAG_NO_FOCUS) ? 0 : LV_DPX(2))
...
static void basic_init(void)
{
    ...
    if ((theme.flags & LVTHEME_FLAG_NO_FOCUS) == 0)
